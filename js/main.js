...
const projectData = [
  ...
  },
  {
    ...
    techStack: ["Python"],
    srcURL: "https://github.com/Ayush0126/Topsis/",
  },
  {
    title: "Covid-19",
    subTitle: "Here you have full control over your links.",
    thumbnail: "../img/thumbnails/covid19.png",
    description:
    ...
    srcURL: "https://ayush0126.github.io/Covid_19/",
  },
  {
    title: "PDF-WORD",
    subTitle: "PDF<->Word Converter",
    thumbnail: "../img/thumbnails/PDF-WORD.png",
    description:
    ...
    srcURL: "https://pdf-word.onrender.com/",
  },
  {
    title: "FoodHelp",
    subTitle:
      "A project to help user know more information about the product (calories, carbs etc..) and to buy them.",
    thumbnail: "../img/thumbnails/FoodHelp.png",
    description:
      "A project to help user know more information about the product (calories, carbs etc..) and to buy them. This project provides a user-friendly interface for searching and viewing food products, along with their nutritional information and purchase options.",
    techStack: ["HTML", "CSS", "JavaScript"],
    srcURL: "https://ayush0126.github.io/FoodHelp/",
  },
  {
    title: "Product Cart",
    subTitle:
      "A product cart application to help user keep and manage products in cart.",
    thumbnail: "../img/thumbnails/ProductCart.png",
    description:
    ...
    elem.innerHTML = buildTemplate(
      `<div class='projects-header'>
       ...
       <div class="card-buttons">
          <a href="https://github.com/Ayush0126" target="_blank" class="card-btn" style="float: right; height: 2.35rem; color: #fff; background-color: #68d372; padding: .375rem .75rem; border-radius: .25rem;"><i class="fa-regular fa-file-code"></i>Source Code</a>
